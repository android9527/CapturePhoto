...
//      int width = (int) (screenResolution.x * getScale());
...
//      int height = (int) (screenResolution.y * getScale());
...
//      int topOffset = (screenResolution.y - height) / 2;
      framingRect = getFramingRect(screenResolution);
//    }
    return framingRect;
  }
  ...
  private static double getScale(){
      int position = SPUtil.getInstance(context).getInt(Constant.SIZE, Constant.DEFAULT_SIZE_POSITION);
      double scale = 0.7;
        switch (position)
        {
            case 0:
